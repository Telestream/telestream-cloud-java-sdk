...
public class QcApiTest {
    ...
    public void createJobTest() throws ApiException {
        String project = null;
        JobData data = null;
        Job response = api.createJob(project, data);
    ...
    public void getJobTest() throws ApiException {
        String project = null;
        String job = null;
        Job response = api.getJob(project, job);
    ...
    public void getProjectTest() throws ApiException {
        String project = null;
        Project response = api.getProject(project);
    ...
    public void listJobsTest() throws ApiException {
        ...
        Integer page = null;
        JobsCollection response = api.listJobs(project, expand, status, perPage, page);
    ...
    public void modifyProjectTest() throws ApiException {
        String project = null;
        Data1 data = null;
        Project response = api.modifyProject(project, data);
    ...
    public void proxyTest() throws ApiException {
        String project = null;
        String job = null;
        Proxy response = api.proxy(project, job);
    ...
    public void signedUrlsTest() throws ApiException {
        String project = null;
        String job = null;
        Map<String, String> response = api.signedUrls(project, job);
    ...
    public void uploadVideoTest() throws ApiException {
        ...
        UploadSession response = api.uploadVideo(project, videoUploadBody);
